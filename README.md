...
- Python port parity evaluation (HTML): _not run yet; will be linked here when generated_

## Notes

- `surveydata/202207/length_weight.csv` is generated by `preprocess_survey_data` and is ignored by default; it was force-added to track R port smoke-test inputs.
